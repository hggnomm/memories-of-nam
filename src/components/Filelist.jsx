...
const FileList = () => {
  ...
  return (
    <>
      ...
      {/* Select Năm */}
      <div className="fixed xl:left-[5.7rem] xl:bottom-[15%] bottom-[36%] left-1/2 transform -translate-x-1/2 flex items-center">
        <select
          id="yearSelect"
          value={selectedYear}
      ...
      {/* Phân trang */}
      <div className="fixed xl:bottom-12 xl:left-[5.8rem] bottom-[28%] left-1/2 transform -translate-x-1/2 flex items-center gap-x-2 text-2xl bg-yellow-200 rounded-full px-2 py-1">
        <span
